    ...
    <div class="container">
        <div class="row g-5">
            ...
            <div class="col-lg-12 wow fadeInUp" data-wow-delay="0.3s">
                ...
                <h1 class="mb-4" style="color: #8e44ad;">Welcome to Novel Book</h1>
                <p class="mb-4">
                    Welcome to NovelBook, where the love for literature comes to life! Established in [Year], we are
                    more than just a bookstore; we are a haven for bibliophiles and a community dedicated to the written
                    word.
                </p>

                <h3 class="mb-4">Our Mission</h3>
                <p class="mb-4">At NovelBook, we are passionate about bringing the joy of reading to book enthusiasts
                ...
                <p class="mb-4"> Founded in 2023, NovelBook is not just a bookstore; it's a community of avid readers,
                ...
                <h3 class="mb-4">Why Choose NovelBook?</h3>
                <ul>
                ...
                <p class="mb-4">Meet the passionate individuals behind NovelBook. Our team is composed of book lovers
                ...
                <p class=" mt-5 mb-4">Thank you for being a part of the NovelBook family. Happy reading!</p>
