    ...
    <div class="container">
        <div class="row g-5">
            ...
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                ...
                <p class="mb-4">Welcome to NovelBook, your go-to destination for a literary adventure! At NovelBook, we
                ...
                <p class="mb-4">At NovelBook, we are committed to curating a diverse collection of novels that cater to
                    every reader's taste. Whether you are an avid fiction lover, a history buff, or someone seeking
                    self-discovery through insightful non-fiction, NovelBook has something special waiting for you. Our
                    ...
                    NovelBook - where every page is a new adventure!
